...
geth --datadir ${DATADIR}/data --keystore ${DATADIR}/keystore --networkid ${NET_ID} --allow-insecure-unlock --unlock $(node /scripts/unlock_arg.js) --password ${DATADIR}/password --etherbase 0 --mine --minerthreads 1 $@
